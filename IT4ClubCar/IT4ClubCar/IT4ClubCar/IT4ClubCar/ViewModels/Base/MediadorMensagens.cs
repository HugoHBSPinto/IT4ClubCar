...
namespace IT4ClubCar.IT4ClubCar.ViewModels.Base
{
    sealed class MediadorMensagensService
    {
        ...
        public enum ViewModelMensagens { JogadorAEditar, JogadorAdicionado, JogadorRemovido, NovoJogo, ProTipConteudo, JogadorPontuacaoAEditar, BuracoPontuacaoAEditar, GuardarPontuacoes, PontuacaoAMostrar, NomeAMostrar, AFecharPopup, CampoAtual, BuracoAtual, JogadorATerminarJogo, AFecharPopupTerminarJogo, JogoAtual, Test };
